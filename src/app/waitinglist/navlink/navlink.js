...
function NavLink() {
  ...
  <Link href = '/waitinglist/newJoinees' className={`${pathname === '/waitinglist/newJoinees' ? 'link px-5 py-1 bg-[#005DB8] text-white font-semibold rounded-lg' : 'link rounded-md px-5 py-1 bg-[#e0e2ec] text-black font-semibold'}`}>New Joinees</Link>
      <Link href = '/waitinglist/waitinglist' className={`${pathname === '/waitinglist/waitinglist' ? 'link ms-3 px-5 py-1 bg-[#005DB8] text-white font-semibold rounded-lg' : 'link rounded-md ms-3 px-5 py-1 bg-[#e0e2ec] text-black font-semibold'}`}>Waiting List</Link>
