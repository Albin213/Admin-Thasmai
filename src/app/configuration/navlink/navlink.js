...
function NavLink() {
  ...
  return (
    ...
    <Link href = '/configuration/help-support'className={`${pathname === '/configuration/help-support' ? 'link ms-3 px-5 py-1  bg-[#005DB8] text-white font-semibold rounded-lg' : 'link rounded-md ms-3 px-5 py-1 bg-[#e0e2ec] text-black font-semibold hover:scale-105'}`}>Help & Support</Link>
