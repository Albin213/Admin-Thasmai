    ...
    const pathname = usePathname()
  	...
  	return (
    	<nav className='w-full h-full flex items-center'>
      		...
      		<Link href = '/message/globalMessage' className={`${pathname === '/message/globalMessage' ? 'link px-5 py-1 bg-[#005DB8] text-white font-semibold rounded-lg' : 'link rounded-md px-5 py-1 bg-[#e0e2ec] text-black font-semibold hover:scale-105'}`}>T-Tok</Link>
