...
import WaitingListTable from "@/app/components/waitinglist/waitinglist/WaitingListTable";
...
function WaitingList() {
	...
	async function handleSearch(page, newRow) {
		...
		try {
			...
			const response = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/superadmin/searchUser?field=${searchRef.current.value}&value=${textRef.current.value}&page=${searchPage}&limit=${rows}`);
