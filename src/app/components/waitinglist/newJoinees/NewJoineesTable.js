...
function NewJoineesTable(props) {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            try {
                const response = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/superadmin/thisMonthDetails?page=${pageNo}&pageSize=${pageRows}&limit=${pageRows}`);                    
...
export default NewJoineesTable;
