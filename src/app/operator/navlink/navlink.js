...
function NavLink() {
  ...
  return (
    <nav className='w-full h-full flex items-center'>
      ...
      <Link href = '/operator/operator-creation' className={`${pathname === '/operator/operator-creation' ? 'link px-5 py-1 bg-[#005DB8] text-white font-semibold rounded-lg' : 'link rounded-md px-5 py-1 bg-[#e0e2ec] text-black font-semibold'}`}>Employee Creation</Link>
